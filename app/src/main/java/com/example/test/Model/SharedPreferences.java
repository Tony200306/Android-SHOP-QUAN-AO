...
public class SharedPreferences {
    ...
    public SharedPreferences(Context appContext) {
    ...
    public ArrayList<Clothes> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Clothes> playerList =  new ArrayList<Clothes>();

        for(String jObjString : objStrings){
            Clothes player  = gson.fromJson(jObjString,  Clothes.class);
    ...
    public void putListObject(String key, ArrayList<Clothes> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Clothes player: playerList){
